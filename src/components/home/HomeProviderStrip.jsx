...
export default function HomeProviderStrip() {
  ...
  return (
    <section className="stb-section-dark stb-section">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            <div className="stb-chip border-primary/30 bg-primary/10 text-primary mb-6">
          ...
          <Link to="/pricing">
            <Button
              variant="outline"
              className="border-white/20 bg-white/5 text-white hover:bg-white/10 rounded-lg h-12 px-6 gap-2"
            >
            ...
            >
              ...
              >
                <CardContent className="p-8 flex flex-col h-full">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed flex-1 mb-6">{card.description}</p>
                  <Link to={card.href}>
                    <Button
                      variant={card.highlighted ? 'default' : 'outline'}
                      className={`w-full rounded-lg ${card.highlighted ? '' : 'border-white/20 bg-transparent text-white hover:bg-white/10'}`}
                    >
                      {card.cta}
                    </Button>
                  </Link>
        ...
        <div className="mt-10 flex flex-wrap gap-4 justify-center text-sm text-muted-foreground">
