...
export default function ReferralLoopBanner({ compact = false, className = '' }) {
    if (compact) {
        return (
            <div className={`stb-notice-warm bg-primary/5 px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 ${className}`}>
    ...
    return (
        <section className={`relative overflow-hidden  bg-charcoal text-white ${className}`}>
            ...
            <div className="relative px-6 sm:px-10 py-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <Button asChild size="lg" className=" bg-card text-charcoal hover:bg-white/90 shrink-0">
