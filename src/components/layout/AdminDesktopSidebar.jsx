...
const adminNavItems = [
  ...
  { label: 'Orders', icon: Package, path: 'AdminOrders' },
  { label: 'Disputes', icon: AlertTriangle, path: 'AdminDisputes' },
  { label: 'Users', icon: Users, path: 'AdminUserModeration' },
  { label: 'Backups', icon: Database, path: 'AdminBackups' },
];
