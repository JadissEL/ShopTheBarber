      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="space-y-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-muted/50 border border-slate-100">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Book elite appointments in seconds with real-time availability and instant confirmation.</p>
            </div>
            <div className="text-center p-6 rounded-2xl bg-muted/50 border border-slate-100">
              <div className="w-14 h-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Access a curated network of master barbers and stylists who are top of their game.</p>
            </div>
            <div className="text-center p-6 rounded-2xl bg-muted/50 border border-slate-100">
              <div className="w-14 h-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Secure payments, verified reviews, and a commitment to satisfaction on every cut.</p>
            </div>
          </div>
