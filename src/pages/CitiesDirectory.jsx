    ...
    return (
        ...
        <div className="stb-page pb-16">
            ...
            <PageHeader
                ...
                subtitle="Local landing pages with top-rated pros, shop listings, and at-home options."
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        {cities.map((city) => (
                            ...
                            <Link key={city.slug} to={`/barbers-in/${city.slug}`}>
                                ...
                                <Card className={cn(stb.surfaceHover, 'h-full border-foreground/10')}>

                                    <CardContent className="p-6 flex items-start justify-between gap-4">

                                        <div>

                                            <h2 className={cn(stb.uiHeading, 'text-xl')}>{city.name}</h2>
                                            ...
                                            <p className="text-xs mt-2 text-foreground font-medium">{city.barber_count} barbers</p>
