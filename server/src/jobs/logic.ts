...
import { canPostJobs as rbacCanPostJobs } from '../auth/platformRbac';
...
export const EMPLOYER_ROLES = ['barber', 'shop_owner', 'provider', 'company', 'seller'] as const;

export type AuthUser = { id: string; email?: string; role?: string; full_name?: string | null; account_type?: string | null };

export function canPostJobs(role?: string | null, accountType?: string | null): boolean {
    return rbacCanPostJobs(role, accountType);
}
