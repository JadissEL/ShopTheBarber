...
- **antigravity-system** – **Always on.** Project conventions; preserve > extend > optimize. Read PROJECT_TRACKER.md before every task; rescan for Sovereign API traces; ensure 100% sovereign and production-ready. Non-destruction, tracker-first, change-control, proactive MCP/API proposals.
